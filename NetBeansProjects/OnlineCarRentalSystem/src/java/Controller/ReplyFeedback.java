...
public class ReplyFeedback extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CFeedback cfeedback = new CFeedback(Integer.parseInt(c_id),dof,content,"Done",reply);
        new UserDAOImpl().updateAccount(cfeedback);
        RequestDispatcher dispatcher = request.getRequestDispatcher("staffmanageFB.jsp");
