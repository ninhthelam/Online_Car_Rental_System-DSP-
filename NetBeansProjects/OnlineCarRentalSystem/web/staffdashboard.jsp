<%-- 
    ...
    Created on : 28-Mar-2020, 13:15:18
    Author     : ninhthelam
--%>
...
<html>
    <head>
        ...
        <title>Online Car Rental System Staff dashboard</title>
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="home.jsp">Pages</a>
                                        <ul>
                                            ...
                                            <li><a href="employeeslogin.jsp">Employees login</a></li>

                                        </ul>
                                    </li>
                                    <li><a href="addCar.jsp">Add new car</a></li>
                                    <li><a href="cardetails.jsp">Manage Cars</a></li>
                                    <li><a href="staffmanageFB.jsp">Check Feedback list</a></li>
                                    <li><a href="staffmanagebooking.jsp">Check Booking list</a></li>
